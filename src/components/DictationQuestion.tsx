  ...
  return (
    <div>
      ...
      <input
        ...
        className="mt-4 w-full px-4 py-2.5 rounded-lg border border-card-border bg-card font-content focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:opacity-70"
      />
      {!disabled && (
        <button
